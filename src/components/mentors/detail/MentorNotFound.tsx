  ...
  return (
    <div className="flex items-center justify-center h-96">
      <div className="text-center">
        <h2 className="text-2xl font-semibold text-gray-600">Ментор не найден</h2>
        <p className="text-gray-500 mt-2">Возможно, этот ментор был удален или не существует.</p>
        <Link 
          href="/mentors" 
